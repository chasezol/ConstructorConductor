...
//Let's say three people signed up for our service, create 3 instances of User and add each to the users Array
 ...
 var chase = new User('Chase', 'chase.zollinger@hotmail.com', 'liljon', 93);
 var brandon = new User('Brandon', 'brandon.zollinger@hotmail.com', 'usher', 85);
 var eric = new User('Eric', 'eric.zollinger@hotmail.com', 'jayz', 70);
